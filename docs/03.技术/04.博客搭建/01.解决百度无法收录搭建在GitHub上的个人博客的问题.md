...
permalink: /baidu-shoulu-github.html
categories: 
  - 技术
  - 博客搭建
tags: 
...
> git 操作部分和使用github的差不多，不了解git操作的可以看我的另一篇文章：[Git使用手册](https://dbdgs.cn/p/9a7ee40fc232253e/)
...
[《GitHub Actions 定时运行代码：每天定时百度链接推送》](https://dbdgs.cn/p/f44d2f9ad04ab8d3/)
